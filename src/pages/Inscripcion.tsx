    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center border bg-card p-10">
          ...
          <Link to="/" className="btn-mechanical bg-primary text-primary-foreground inline-flex">
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 lg:px-8">
        ...
        <div className="mb-10 text-center">
          ...
          <h1 className="font-satoshi text-4xl font-black leading-tight text-foreground md:text-5xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="border bg-card p-6 md:p-8">
            ...
            <p className="mb-6 text-xs text-muted-foreground">
              <span className="font-mono text-primary font-bold">Pre-Venta:</span> Precio especial para los primeros {PREVENTA_LIMIT} cupos.
            </p>
            ...
            {/* Tipo de franela */}
            {formData.modalidad === "con-franela" && (
              <div className="mt-4 ml-8 border-l-2 border-primary/20 pl-6">
