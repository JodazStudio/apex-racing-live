              ...
              <div key={athlete.bib} className="p-4 hover:bg-muted/30 transition-colors animate-in slide-in-from-right-4 duration-500">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-satoshi font-black text-sm uppercase truncate">
                      {athlete.name}
                    </div>
                ...
                {finishers[0].bib === athlete.bib && (
                  <div className="mt-3 flex items-center gap-2 bg-primary/10 border border-primary/20 px-2 py-1 rounded-sm">
