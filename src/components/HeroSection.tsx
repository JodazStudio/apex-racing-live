  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 text-center">
        ...
        {/* Headline */}
        <h1 className="font-satoshi text-5xl font-black leading-[0.95] tracking-tight md:text-7xl lg:text-8xl">
          PRECISIÓN EN
          <br />
        ...
        {/* Subheadline */}
        <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-hero-foreground/70 md:text-xl">
